...
Omamessage is an Omarchy bar inbox. It is not Apple iMessage and it does not bundle Tether. Tether talks to the iPhone from Linux — no macOS VM (unlike BlueBubbles). Install Tether first, pair your iPhone over Bluetooth, then add this plugin. It follows the Omarchy light/dark theme. Tether is by Zack Bartel: https://github.com/zackb/tether
